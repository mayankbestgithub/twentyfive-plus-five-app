...
const Activity = () => {
    ...
    return (<div>
        <span id="break-label">
            ...
            <div>
                <button id="break-decrement" onClick={() => dispatch(decrement('break'))}>&#8595;</button>
                <span id="break-length">{breakL}</span>
                <button id="break-increment" onClick={() => dispatch(increment('break'))}>&#8593;</button>
            </div>
        </span>
        <span id="session-label">
            ...
            <div>
                <button id="session-decrement" onClick={() => dispatch(decrement('session'))}>&#8595;</button>
                <span id="session-length">{sessionL}</span>
                <button id="session-increment" onClick={() => dispatch(increment('session'))}>&#8593;</button>
            </div>
        </span>
    </div>)
}
